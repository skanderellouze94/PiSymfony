...
class HerboriseterieController extends Controller
{
    public function indexAction(Request $request)
    {
        ...
        $dql   = "SELECT m FROM EtablissementBundle:Etablissements m WHERE (m.type='Herboriseterie') ORDER BY m.id DESC ";
