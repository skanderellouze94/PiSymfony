...
class Notification
{
     ...
     * Set idReceiver
     *
     * @param \RdvBundle\Entity\FosUser $idReceiver
     *
     * @return Notification
     */
    public function setIdReceiver(\RdvBundle\Entity\FosUser $idReceiver = null)
    {
     ...
     * Set idRdv
     *
     * @param \RdvBundle\Entity\Rdv $idRdv
     *
     * @return Notification
     */
    public function setIdRdv(\RdvBundle\Entity\Rdv $idRdv = null)
    {
        $this->idRdv = $idRdv;
